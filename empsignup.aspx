<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="empsignup.aspx.cs" Inherits="empsignup" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <asp:Label ID="Label1" runat="server" Text=" Register Here " style="z-index: 100; left: 256px; position: absolute; top: 202px" Font-Names="Modern" Font-Size="32pt" ForeColor="Red" Width="231px"></asp:Label>
    ...
    <tr><td style="width: 176px">Phone Number</td><td><asp:TextBox ID="phtxt" runat="server"></asp:TextBox></td><td style="width: 157px"></td></tr>
          <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate ="phtxt" ValidationExpression ="\d+" Display ="Static" EnableClientScript ="true" ErrorMessage ="* Please enter numbers only" runat ="server" />
